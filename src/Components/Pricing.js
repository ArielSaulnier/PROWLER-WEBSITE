    ...
    <div className="bg-blue-800">
      <div className="px-4 pt-12 sm:px-6 lg:px-8 lg:pt-20">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-4xl text-xl text-blue-200 sm:mt-5 sm:text-2xl">
                    ...
                    <div className="flex flex-1 flex-col justify-between border-t-2 border-gray-100 bg-gray-50 p-6 sm:p-10 lg:p-6 xl:p-10">
                      ...
                      <div className="mt-8">
                        <div className="rounded-lg shadow-md">
                          <a
                            href="#"
                            className="block w-full rounded-lg border border-transparent bg-white px-6 py-3 text-center text-base font-medium text-blue-600 hover:bg-gray-50"
                ...
                <div className="relative z-10 rounded-lg shadow-xl">
                  ...
                  <div className="absolute inset-x-0 top-0 translate-y-px transform">
                    <div className="flex -translate-y-1/2 transform justify-center">
                      <span className="inline-flex rounded-full bg-blue-600 px-4 py-1 text-base font-semibold text-white">
                        Most popular
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="rounded-b-lg border-t-2 border-gray-100 bg-gray-50 px-6 pt-10 pb-8 sm:px-10 sm:py-10">
                    ...
                    <div className="mt-10">
                      <div className="rounded-lg shadow-md">
                        <a
                          href="#"
                          className="block w-full rounded-lg border border-transparent bg-blue-600 px-6 py-4 text-center text-xl font-medium leading-6 text-white hover:bg-blue-700"
